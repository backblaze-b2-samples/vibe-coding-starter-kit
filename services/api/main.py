...
#
# Which settings are required, and which placeholder values count as unset, come
# from app/config/b2_required_vars.json — the same file scripts/doctor.mjs
# parses. Nothing to keep in sync here.
